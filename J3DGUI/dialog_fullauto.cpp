...
{
	Global::fullauto_InPutDir = QFileDialog::getExistingDirectory(this, u8"浏览源图片路径 ", "", NULL);
	ui->lineEdit_inputDir->setText(Global::fullauto_InPutDir);
}

void Dialog_FullAuto::on_pushButton_browseOutputDir_clicked()
{
	Global::fullauto_OutputDir = QFileDialog::getExistingDirectory(this, u8"浏览工程输出路径 ", "", NULL);

...
我也将这个项目开源在github上，如果有想在windows下配置环境编译的同学可以fork下来研究研究，由于是个人项目，只是为了实现效果，代码很烂，也难免也会有一些bug啦，若是有什么Bug或者其他问题和可以私信联系我。或者不愿意麻烦的，可以直接下编译后的qt程序直接windows下跑就行，希望给同是研究三维重建这一块的同学们帮上一些小忙。
